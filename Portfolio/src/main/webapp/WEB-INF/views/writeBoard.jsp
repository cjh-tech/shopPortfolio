      ...
      <div class="col-md-9 col-lg-9">
        <form method="post" action="writeBoard">
           <table class="table">
			 <tr>
                <th>제목:</th>
                <td><input type="text"  placeholder="제목을 입력하세요." name="subject"/>작성자:${id}</td>
             </tr>
            <tr>
                <th>내용:</th>
                <td><textarea cols="70"  rows ="10" placeholder="내용을 입력하세요. " name="contents"></textarea></td>
            </tr>
		   </table>
		   <input type="submit" value="작성완료" action="writeBoard"/>
