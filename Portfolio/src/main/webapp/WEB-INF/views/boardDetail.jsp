    ...
    <div class="container">
      ...
      <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1" data-hover="dropdown" data-animations="fadeIn fadeInLeft fadeInUp fadeInRight">
        <ul class="nav navbar-nav navbar-right">
          <li class><a href="main">베스트상품</a></li>
           ...
           <table border="1" class="table">
            <caption>문의게시판</caption>
               <form method="post" action="updateBoard">
                ...
                <tr>
                    <td>제목</td>
                    <td><input type="text" name="subject" value="${list.get(0).getSubject()}"/></td>
                </tr>
                <tr>
                    <td>내용</td>
                    <td><input type="text" name="contents" value="${list.get(0).getContents()}"/></td>
                </tr>
                <tr>
                    <td>글작성일</td>
                ...
                <tr>
                    <td>글조회수</td>
                    <td>${list.get(0).getCount()}</td>
                </tr>
        </table>
        <input type="hidden" name="idx" value="${list.get(0).getIdx()}">   
        <a href="#" onclick="history.back(-1)">돌아가기</a>
        <a href="deleteBoard?idx=${list.get(0).getIdx()}">삭제</a>
