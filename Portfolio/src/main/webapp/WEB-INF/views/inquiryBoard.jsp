...
<section id="inner-title" class="inner-title">
  <div class="container">
    <div class="row">
      <div class="col-md-6 col-lg-6"><h2>문의 게시판</h2></div>
                ...
                <tfoot>
	               	<tr>
	               		<td colspan="5" class="text-center">
							<ul class="pagination">
								<c:if test="${page.prev}">
									<li><a href="${pageContext.request.contextPath}/inquiryboard?page=${page.prePage}" aria-label="Previous"><span aria-hidden="true">&laquo;</span></a></li>
								</c:if>
							
								<c:forEach var="pageNum" begin="${page.startPage }" end="${page.endPage}">
									<c:choose>
										<c:when test="${pageNum eq page.cri.page }">
											<li class="active"><a href="${pageContext.request.contextPath}/inquiryboard?page=${pageNum}">${pageNum}<span class="sr-only">(current)</span></a></li>
										</c:when>
										<c:otherwise>
											<li><a href="${pageContext.request.contextPath}/inquiryboard?page=${pageNum}">${pageNum}</a></li>
										</c:otherwise>
									</c:choose>
								</c:forEach>
								
								<c:if test="${page.next}">
									<li><a href="${pageContext.request.contextPath}/inquiryboard?page=${page.nextPage}" aria-label="Previous"><span aria-hidden="true">&raquo;</span></a></li>
								</c:if>
							</ul>			
	               		</td>
	               	</tr>
